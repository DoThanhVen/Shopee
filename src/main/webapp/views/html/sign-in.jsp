				...
				<form action="/login" method="POST">
					...
					<div class="mb-3">
						<input type="text" id="phone"
							placeholder="Số điện thoại" name="username">
					</div>
					<div class="mb-3">
						<input name="password" type="password" value=""
							class="input form-control" id="password" placeholder="Mật khẩu" />
					</div>
					<span class="error-message" aria-live="polite">${error}</span>
					<button type="submit" class="btn btn-primary">ĐĂNG NHẬP</button>
					<div class="forgot-password">
						<a href="/home/forgot-password">Quên mật khẩu</a> <a href="#">Đăng
							nhập với SMS</a>
					</div>
					<div class="more row">
					...
					<div class="sign-in">
						Bạn mới biết đến Shopee? <a href="/home/sign-up">Đăng ký</a>
					</div>
				</form>
			</div>
		</div>
